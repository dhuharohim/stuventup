                ...
                <div class="container">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <div class="d-flex justify-content-between align-items-center navbar-top">
                            <div>
                                <a class="navbar-brand" href="#"><img src="assets/img/stuventText.png" style="width: 50%;" alt="" /></a>
                            </div>
                            <div>
                                <div class="navbar-right" style="justify-content: right">
                                    @if ($user == NULL)
                                    <a href="{{ route('login') }}" style="color:inherit;">Login |  </a>
                                    <a href="{{ route('register') }}" style="color:inherit; margin-left:0.25rem">Register</a>
                ...
                <div class="banner-top-thumb-wrap">
                    <div class="d-lg-flex justify-content-between align-items-center">
                        <div class="d-flex justify-content-between  mb-3 mb-lg-0">
                            <div>
                                <img src="assets/img/dashboard/star-magazine-1.jpg" alt="thumb"
                        ...
                        <div class="d-flex justify-content-between mb-3 mb-lg-0">
                            <div>
                                <img src="assets/img/dashboard/star-magazine-2.jpg" alt="thumb"
                                    class="banner-top-thumb" />
                            </div>
                        ...
                        <div class="d-flex justify-content-between mb-3 mb-lg-0">
                            <div>
                                <img src="assets/img/dashboard/star-magazine-3.jpg" alt="thumb"
                                    class="banner-top-thumb" />
                            </div>
                            <h5 class="m-0 font-weight-bold">
                        ...
                        <div class="d-flex justify-content-between mb-3 mb-lg-0">
                            <div>
                                <img src="assets/img/dashboard/star-magazine-4.jpg" alt="thumb"
                                    class="banner-top-thumb" />
                            </div>
                            <h5 class="m-0 font-weight-bold">
                        ...
                        <div class="owl-carousel owl-theme" id="main-banner-carousel">
                            ...
                            <div class="item">
                                <div class="carousel-content-wrapper mb-2">
                                    ...
                                    <div class="carousel-image">
                                        <img src="assets/img/dashboard/banner_1.jpg" alt="" />
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                                <div class="carousel-content-wrapper mb-2">
                                    ...
                                    <div class="carousel-image">
                                        <img src="assets/img/dashboard/banner_2.jpg" alt="" />
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                                <div class="carousel-content-wrapper mb-2">
                                    ...
                                    <div class="carousel-image">
                                        <img src="assets/img/dashboard/banner_3.jpg" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="py-3 border-bottom">
                                    <div class="d-flex align-items-center pb-2">
                                        <img src="assets/img/dashboard/Profile_1.jpg"
                            ...
                            <div class="col-sm-6">
                                <div class="py-3 border-bottom">
                                    <div class="d-flex align-items-center pb-2">
                                        <img src="assets/img/dashboard/Profile_2.jpg"
                                            class="img-xs img-rounded mr-2" alt="thumb" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="pt-3 pb-4 border-bottom">
                                    <div class="d-flex align-items-center pb-2">
                                        <img src="assets/img/dashboard/Profile_4.jpg"
                                            class="img-xs img-rounded mr-2" alt="thumb" />
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="pt-4 pb-4">
                                    <div class="d-flex align-items-center pb-2">
                                        <img src="assets/img/dashboard/Profile_5.jpg"
                                            class="img-xs img-rounded mr-2" alt="thumb" />
                            ...
                            <div class="col-sm-6">
                                <div class="pt-3 pb-4">
                                    <div class="d-flex align-items-center pb-2">
                                        <img src="assets/img/dashboard/Profile_6.jpg"
                                            class="img-xs img-rounded mr-2" alt="thumb" />
